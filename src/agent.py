...
from models.tokenizer import SpatialBroadcastDecoder
...
class Agent(nn.Module):
    ...
    def load(self, path_to_checkpoint: Path, device: torch.device, load_tokenizer: bool = True, load_world_model: bool = True, load_actor_critic: bool = True, load_image_decoder: bool = True) -> None:
